      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link <?php echo e(Request::routeIs('products') ? 'active' : ''); ?>" href="<?php echo e(route('products')); ?>">Our Products</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo e(Request::routeIs('about') ? 'active' : ''); ?>" href="<?php echo e(route('about')); ?>">About Us</a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo e(Request::routeIs('contact') ? 'active' : ''); ?>" href="<?php echo e(route('contact')); ?>">Contact Us</a>
            </li>
...
<?php /**PATH /media/armin/New Volume1/blogg/onlineShop/shop/resources/views/layout.blade.php ENDPATH**/ ?>